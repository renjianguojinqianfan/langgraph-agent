...
| skills 运行时 | P4+收敛证据（Hermes/dsh 双收敛）| Skill use 是五维原子能力之一（qwen3.6-plus 实测 **0.3562**，全表最低切片之一）| ✅ **P1-A 已交付**（PR #42）|
...
feat/skills-runtime       ← P1-A skills 运行时（已合入，PR #42；load_skill + inject 共享发现抽取，零碰保护文件）
